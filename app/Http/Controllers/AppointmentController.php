...
class AppointmentController extends Controller
{
    ...
    {
        $myappointments = Appointment::latest()->where('user_id',auth()->user()->id)->orderby('date')->get();
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->back()->with('message','Horario Guardados para '. $request->date);
    }
    ...
    public function check(Request $request){
        ...
        if(!$appointment){
            return redirect()->to('/appointments')->with('errmessage','Fecha no disponiible');
        }
    ...
    public function updateTime(Request $request){
        ...
        return redirect()->route('appointments.index')->with('message','Horarios Actualizado');
    }
}
