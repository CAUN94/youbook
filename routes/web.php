...
Route::get('/rsf','RedirectController@rsf');
Route::get('/registro','RedirectController@registro');
Route::get('/comunicaciones','RedirectController@comunicaciones');
...
Route::group(['middleware'=>['auth','trainer']], function(){
	...
	Route::get('/train_toogleid/{id}','AdminTrainingController@toggleStatusid')->name('admin.training.toogleid');
