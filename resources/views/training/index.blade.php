            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @if(!$training_user->settled)
                        <p>El costo es de <strong>{{Auth::user()->planPrice()}}</strong></p>
                    @endif
                    ...
                    <form class="d-inline" method="post" action="/training">
                        ...
                        <span class="badge badge-secondary"><button type="submit" onclick="return confirm('Seguro?')">Cambiarme de Plan</button></span>
                    </form>
                </div>
            </div>
        </div>
