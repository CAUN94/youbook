...
¿Cómo estás?
<br><br>
Se viene un nuevo mes de entrenamiento, por lo que te recordamos que renueves tu plan en nuestra plataforma https://yjb.cl/training en la opción de "Por Pagar".
<br><br>
Tu plan actual es {{$info->name}} con un valor de {{$info->format}}.
