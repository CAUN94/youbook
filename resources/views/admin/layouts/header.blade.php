                ...
                <div class="container-fluid">
                    <div class="d-flex justify-content-between">
                        ...
                        <div class="top-menu d-flex align-items-center">
                            ...
                            <div class="dropdown">
                                <a class="dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img class="avatar thumb1" src="{{asset('img/professionals')}}/{{auth()->user()->image}}" alt=""></a>
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="userDropdown">
                                    <a class="dropdown-item" href="#"><i class="ik ik-user dropdown-icon"></i> Perfil</a>
                                    <a class="dropdown-item" href="{{url('/')}}"><i class="ik ik-home dropdown-icon"></i> Inicio</a>
                                    <a class="dropdown-item" href="#"><i class="ik ik-settings dropdown-icon"></i> Modificaciones</a>
